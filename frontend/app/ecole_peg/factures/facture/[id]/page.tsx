  ...
  return (
    <div className="flex flex-col gap-4 max-w-3xl mx-auto pb-8">
      ...
      <div className="flex items-center gap-3 mt-4">
        ...
        <h1 className="text-3xl font-bold tracking-tight">Détail de la facture</h1>
      </div>
      ...
      {/* Partie PDF */}
      <div ref={factureRef} className="bg-white rounded-2xl shadow-lg p-0 print:p-0 border">
        <Card className="border-none shadow-none">
          <CardContent className="p-8">
            ...
            <div className="flex flex-col md:flex-row md:justify-between gap-4">
              <div>
                ...
                <div className="text-sm text-muted-foreground">
                  ...
                  <p>
                    <span className="font-medium">Email:</span> info@ecole-peg.ch
                  </p>
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-gray-100 border-b">
                    ...
                    <th className="py-3 px-2 text-left font-semibold text-sm">Période</th>
                    <th className="py-3 px-2 text-right font-semibold text-sm">Prix</th>
                  </tr>
                </thead>
                <tbody>
                    ...
                    <tr key={detail.id} className="border-b last:border-b-0">
                      ...
                      <td className="py-3 px-2">
                        {detail.date_debut_periode
                          ? "Du " + format(detail.date_debut_periode, "dd-MM-yyyy")
                          : ""}
                        {detail.date_fin_periode
                          ? " au " + format(detail.date_fin_periode, "dd-MM-yyyy")
                          : ""}
                      </td>
                  ...
                  <tr>
                    <td className="py-4 px-2 text-right font-bold text-base" colSpan={2}>
                      Total à payer
                    </td>
            ...
            <div className="mt-8 rounded-lg border bg-blue-50 p-4">
              <h3 className="font-semibold mb-2 text-blue-800">Coordonnées bancaires :</h3>
      ...
      <div className="flex justify-end mt-6">
        <Button
          ...
          onClick={() => router.push(`/ecole_peg/factures/facture/${factureId}/payer`)}
        >
          Payer
        </Button>
      </div>
